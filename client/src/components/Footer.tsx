  ...
  return (
    <footer className="bg-secundary py-20 text-slate-100">
      <div className="max-container padding-x flex flex-col gap-8 md:block">
        ...
        <div className="order-1 grid gap-8">
          <ul className="flex gap-5 justify-center items-center text-slate-200">
            <li>
              <a
                href="https://github.com/CristianDaniel1"
                target="_blank"
                className="sm:hover:text-primary active:text-primary duration-200"
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/cristiandaniel1/"
                target="_blank"
            ...
            <li>
              <a
                href="mailto:cristiandaniel.1050@gmail.com"
